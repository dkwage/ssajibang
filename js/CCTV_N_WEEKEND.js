...
function updateTotalMembers() {
  ...
  const exceptions =
    vacation1 + sleepOver1 + goingOut1 + sleepOver2 + goingOut2 + vacation2;
  ...
  const dorm1Current = dorm1Total - vacation1 - sleepOver1 - goingOut1;
...
function generateAndCopyText() {
  ...
  }명, 외출 ${document.getElementById("goingOut1").value}명
