...
function updateTotalMembers() {
  ...
  const goingOut1 =
    parseInt(document.getElementById("goingOut1").value, 10) || 0;
  const dispatch1 =
    parseInt(document.getElementById("dispatch1").value, 10) || 0;
  ...
  const goingOut2 =
    parseInt(document.getElementById("goingOut2").value, 10) || 0;
  const exceptions =
    vacation1 +
    sleepOver1 +
    goingOut1 +
  ...
  const dorm1Current =
    dorm1Total - vacation1 - sleepOver1 - goingOut1 - dispatch1;
  document.getElementById("dorm1Current").value = dorm1Current;

  const dorm2Current = dorm2Total - sleepOver2 - goingOut2 - vacation2;
  ...
  const dorm1Sleeping = dorm1Current - dorm1Saji - dorm1Chedan - dorm1Duty;
  ...
  const dorm2Sleeping = dorm2Current - dorm2Saji - dorm2Chedan - dorm2Duty;
...
document
  ...
  .addEventListener("input", updateTotalMembers);
document
  .getElementById("goingOut1")
  .addEventListener("input", updateTotalMembers);
document
  .getElementById("dispatch1")
  .addEventListener("input", updateTotalMembers);
...
function generateAndCopyText() {
  ...
  나. 열외 : ${document.getElementById("exceptions").value}명
      1) 1생활관 : 휴가 ${document.getElementById("vacation1").value}명, 외박 ${
    document.getElementById("sleepOver1").value
  }명, 외출 ${document.getElementById("goingOut1").value}명, 파견 ${
    document.getElementById("dispatch1").value
  }명
      2) 2생활관 : 휴가 ${document.getElementById("vacation2").value}명, 외박 ${
    document.getElementById("sleepOver2").value
  }명, 외출 ${document.getElementById("goingOut2").value}명
